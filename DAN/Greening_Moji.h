...
namespace greenig_MojiNS
{
	...
	const D3DXVECTOR3 POSITION_RYOKUKA_01 = D3DXVECTOR3(240 * WINDOW_WIDTH / 1920, 4500, 0);//プレイヤー１用初期位置
	const D3DXVECTOR3 POSITION_RYOKUKA_02 = D3DXVECTOR3(1190 * WINDOW_WIDTH / 1920, 4500, 0);//プレイヤー２用初期位置
