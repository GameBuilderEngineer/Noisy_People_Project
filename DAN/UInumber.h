...
namespace uiNumberNS
{
	...
	const D3DXVECTOR3 P1_GREENIG_POS = D3DXVECTOR3(835 * WINDOW_WIDTH / 1920, 415 * WINDOW_HEIGHT / 1080, 0);	//P1用緑化率の表示位置
	const D3DXVECTOR3 P2_GREENIG_POS = D3DXVECTOR3(1800 * WINDOW_WIDTH / 1920, 415 * WINDOW_HEIGHT / 1080, 0);	//P1用緑化率の表示位置
	...
	const D3DXVECTOR3 GREENING_PERSENT_POS = D3DXVECTOR3(1150 * WINDOW_WIDTH / 1920, 220 * WINDOW_HEIGHT / 1080, 0);	//P1用撃退数の表示位置
